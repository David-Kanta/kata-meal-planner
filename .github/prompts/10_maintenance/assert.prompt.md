...
Assert that a feature must work as intended:
...
- Make sure coding rules are respected: @docs/rules.md
- Steps are a flow, you must follow them
- Use playwright MCP when navigating URL
- **Only when necessary** : Put logs if necessary to debug web values (remove those after fixing the issue)
- Suppose all servers already started
