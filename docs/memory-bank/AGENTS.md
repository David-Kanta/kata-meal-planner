...
- @docs/memory-bank/backend/API_DOCS.md — placeholder and guidance for backend APIs (none detected).
- @docs/memory-bank/backend/DATABASE.md — placeholder guidance for database docs (none detected).
- @docs/memory-bank/frontend/BACKEND_COMMUNICATION.md — guidance to map frontend ↔ backend (no frontend detected).
- @docs/memory-bank/frontend/DESIGN.md — frontend design guidance placeholder.
- @docs/memory-bank/frontend/FORMS.md — forms and validation guidance placeholder.
